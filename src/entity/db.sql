...
select * from d_product  where add_time >= 1237873000234 Order by add_time desc;
select * from d_category_product ;
select * from d_order;
select * from d_item;
select * from d_receive_address;
desc d_order;
desc d_receive_address;
select count(*) from d_category_product d join (select 
a.id productId ,product_name,description,add_time,fixed_price,dang_price,keywords,has_deleted,
product_pic,author,publishing,publish_time ,word_number,which_edtion,total_page,
print_time,print_number,isbn,author_summary,catalogue 
 from d_product  a join d_book b on a.id=b.id ) c on c.productId=d.product_id where cat_id=8;
...
DROP database IF EXISTS ashop;
create database ashop  default character set utf8;
use ashop;
...
INSERT INTO d_product VALUES (1,'上','上',1237873000234,200,180,'key',0,'16.jpg');
INSERT INTO d_product VALUES (2,'上课','上课',1237873000234,200,180,'key',0,'17.jpg');
INSERT INTO d_product VALUES (3,'上课头','上课头',1237873000234,200,180,'key',0,'18.jpg');
INSERT INTO d_product VALUES (4,'上课头疼的','上课头疼的',1237873000234,200,180,'key',0,'19.jpg');
INSERT INTO d_product VALUES (5,'上课头疼的故','上课头疼的故',1237873000234,200,180,'key',0,'20.jpg');
INSERT INTO d_product VALUES (6,'上课头疼的故事','上课头疼的故事',1237873000234,200,180,'key',0,'21.jpg');
INSERT INTO d_product VALUES (7,'这里是书的书名','这里是书的书名',1237873000234,200,180,'key',0,'22.jpg');
INSERT INTO d_product VALUES (8,'这里是书的书','这里是书的书',1237873000234,200,180,'key',0,'23.jpg');
INSERT INTO d_product VALUES (9,'这里是书的','这里是书的',1237873000234,200,180,'key',0,'24.jpg');
INSERT INTO d_product VALUES (10,'这里是书','这里是书',1237873000234,200,180,'key',0,'2.jpg');
INSERT INTO d_product VALUES (11,'这里是','这里是',1237873000234,200,180,'key',0,'3.jpg');
INSERT INTO d_product VALUES (12,'这里','这里',1237873000234,200,180,'key',0,'4.jpg');
INSERT INTO d_product VALUES (13,'这','这',1237873000234,200,180,'key',0,'5.jpg');
INSERT INTO d_product VALUES (14,'24小时精通java7','24小时精通java7',1237873000234,200,180,'key',0,'6.jpg');
INSERT INTO d_product VALUES (15,'24小时精通java6','24小时精通java6',1237873000234,200,180,'key',0,'7.jpg');
INSERT INTO d_product VALUES (16,'24小时精通java5','24小时精通java5',1237873000234,200,180,'key',0,'8.jpg');
INSERT INTO d_product VALUES (17,'24小时精通java4','24小时精通java4',1237873000234,200,180,'key',0,'9.jpg');
INSERT INTO d_product VALUES (18,'48小时精通java7','48小时精通java7',1237873000234,200,180,'key',0,'10.jpg');
INSERT INTO d_product VALUES (19,'48小时精通java6','48小时精通java6',1237873000234,200,180,'key',0,'11.jpg');
INSERT INTO d_product VALUES (20,'48小时精通java5','48小时精通java5',1237873000234,200,180,'key',0,'12.jpg');
INSERT INTO d_product VALUES (21,'48小时精通java4','48小时精通java4',1237873000234,200,180,'key',0,'13.jpg');
INSERT INTO d_product VALUES (22,'36小时精通java7','24小时精通java7',1237873000234,200,180,'key',0,'14.jpg');
INSERT INTO d_product VALUES (23,'36小时精通java6','36小时精通java6',1237873000234,200,180,'key',0,'15.jpg');
INSERT INTO d_product VALUES (24,'36小时精通java2','36小时精通java6',1237873000234,200,180,'key',0,'15.jpg');
update d_product set add_time=1344393891815;
select * from d_product  a join d_book b on a.id=b.id
...
INSERT INTO d_book VALUES (1,'我','地球出版社',1237873000234,'1万','1','100',1,NULL,'12345678','作者是好人','这真是一本好书啊');
INSERT INTO d_book VALUES (2,'我写','地球出版社',1237873000234,'1万','1','100',1,NULL,'12345678','作者是好人','这真是一本好书啊');
...
select parent_id from d_category groupby  parent_id ;
select * from d_product where id in(select product_id from d_category_product where cat_id=2);
